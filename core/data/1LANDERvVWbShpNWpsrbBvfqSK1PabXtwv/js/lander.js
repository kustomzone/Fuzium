...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/lib/Promise.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/lib/Property.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/lib/maquette.js ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/Animation.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/Class.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/Dollar.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/ItemList.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/Menu.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/Prototypes.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/RateLimit.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/RateLimitCb.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/Text.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/Time.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/Translate.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/utils/ZeroFrame.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/FileList.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/Head.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/Site.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/SiteFiles.coffee ---- */
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/SiteList.coffee ---- */
...
(function() {
  ...
  SiteList = (function(_super) {
    ...
    SiteList.prototype.updateInactiveDemoSites = function() {
      ...
      demo_site_rows = [
        {
          address: "1CHESSMTP3DDGu4VdrPEhp6gfHLseed2Xg",
          demo: true,
          content: {
            title: "ZeroChess",
            domain: ""
    ...
    SiteList.prototype.render = function() {
      ...
      return h("div#SiteList", [
        this.sites_needaction.length > 0 ? h("h2.needaction", "Running out of size limit:") : void 0, h("div.SiteList.needaction", this.sites_needaction.map(function(item) {
          ...
          return item.render();
        })), h("h2.connected", "Sites:"), h("div.SiteList.connected", this.sites_connected.map(function(item) {
          return item.render();
...
/* ---- /1LANDERvVWbShpNWpsrbBvfqSK1PabXtwv/js/Lander.coffee ---- */
